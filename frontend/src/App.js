...
function App() {
  ...
  const handleCardClick = (productId) => {
    setZoomedProductId(productId === zoomedProductId ? null : productId);  // Toggle zoom
  };
  ...
  const handleImageError = (e) => {
    if (e.target.src !== '/images.jpeg') {
      e.target.src = '/images.jpeg'; // fallback image
    }
  };  
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Welcome to Himanshu's Bakery 🥐👨‍🍳</h1>
        <nav>
      ...
      <div className="container">
                ...
                <div key={product.id} className="product-card">
                  <div className="product-image">
                    {product.image_url ? (
                      ...
                      alt={product.name}
                      onError={(e) => {
                        if (!e.target.src.includes('/jordan_marsh_blueberry_muffin1.jpeg')) {
                          e.target.src = '/jordan_marsh_blueberry_muffin1.jpeg';
                        }
                      }}
                    />
                    ) : (
                      <img src="/jordan_marsh_blueberry_muffin1.jpeg" alt={product.name} />
                    )}
                  </div>
        ...
        {view === 'confirmation' && (
          <div className="confirmation-container">
            ...
            <p>Thank you for ordering from Himanshu Bakery!</p>
            <p>Your order ID is: <strong>{orderId}</strong></p>
            <p>You can check your order status anytime using your ORDER ID.</p>
